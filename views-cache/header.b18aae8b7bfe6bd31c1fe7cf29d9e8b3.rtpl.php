        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="/res/admin/dist/img/foto-perfil.jpg" class="user-image" alt="User Image">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs">Raul Mariaci Neto</span>
            </a>
            <ul class="dropdown-menu">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="/res/admin/dist/img/foto-perfil.jpg" class="img-circle" alt="User Image">
        </div>
        <div class="pull-left info">
          <p>Raul Mariaci Neto</p>
          <!-- Status -->

    ...
    <section class="invoice">
        ...
        <div class="row">
            ...
            <h2 class="page-header">
                <img src="/res/site/img/Logo-RD.png" alt="Logo">
        ...
        <div class="row invoice-info">
            ...
            De
            <address>
                <strong>RDCommerce - Solução para PME's </strong><br>
                Rua Major José Inácio, 1876 - Centro<br>
                São Carlos - SP<br>
                Telefone: (16) 3419-5366<br>
                E-mail: contato@rdcommerce.com.br
            </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
